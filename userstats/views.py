...
class ExpenseSummaryStatsAPI(APIView):
    ...
    def get(self, request):
        ...
        return Response({'category-data': final}, status=status.HTTP_200_OK)
    

class IncomeSourceSummaryStatsAPI(APIView):
    ...
    def get(self, request):
        ...
        return Response({'source-data': final}, status=status.HTTP_200_OK)
